			...
			<c:if test="${userMessages.size() == 0}">
			    ...
			    <div class="messageContainer" >
			    	<div class="messageAuthor">
			    		<c:out value="Day Trip to Scarva"/>
			    		<div style="float:right;">${message.timeStamp}</div><hr />
			    	</div>
			    	<div class="messageContent">
			        	All inclusive trip to Scarva for £19.99 on 19/04/2013 leaving Dundee at 09:30am.
			        </div>
			        <div class="timeAgo">
				...
				<div class="messageContainer" >
			    	<div class="messageAuthor">
			    		<c:out value="Africian Jungle Tour"/>
			    		<div style="float:right;">${message.timeStamp}</div><hr />
			    	</div>
			    	<div class="messageContent">
			        	Flights and Hotel to Africa for a week for £59.99 on 01/05/2013 leaving Edinburgh at 7.45am.
			        </div>
			        <div class="timeAgo">
			        	<p class="timestamp">${message.timeStamp}</p>
					</div>
